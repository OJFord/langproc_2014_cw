...
#ifndef C89ParserBase_h_included
#define C89ParserBase_h_included
...
// $insert polymorphicSpecializations
    ...
    template <>
    struct TagOf<std::vector<double>>
    {
        static Tag__ const tag = Tag__::VECT;
    };
...
inline bool C89ParserBase::debug() const
{
    return d_debug__;
}

inline void C89ParserBase::setDebug(bool mode)
{
    d_debug__ = mode;
}

inline void C89ParserBase::ABORT() const
{
    // $insert debug
    if (d_debug__)
...
inline void C89ParserBase::ACCEPT() const
{
    // $insert debug
    if (d_debug__)
...
inline void C89ParserBase::ERROR() const
{
    // $insert debug
    if (d_debug__)
...
#define C89Parser C89ParserBase
